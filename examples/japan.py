...
def main():
    ...
    # Locked-in and locked-out drivers/constructors
    locked_in_drivers = {"ALB", "SAI", "STR", "PIA"}
    locked_out_drivers = {"RUS"}
    locked_out_constructors = {"WIL"}

    # Combined locked sets for the optimizer
    locked_in = locked_in_drivers
    ...
    optimizer = TeamOptimizer(
        ...
        budget=109.59,  # Available budget
    )
